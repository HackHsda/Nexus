 ...
 */
package com.github.polyrocketmatt.nexus.paper.metrics;
...
public class PaperMetrics implements NexusMetrics {
     ...
     */
    public PaperMetrics(JavaPlugin plugin, int serviceId) {
